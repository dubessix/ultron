...
const GalleryView = () => {
  ...
  return (
    <div className="flex-1 bg-iris-bg-primary h-full p-8 animate-in fade-in zoom-in duration-500 flex flex-col overflow-hidden">
      <div className="flex items-center justify-between pb-6 border-b border-iris-border-primary mb-6 shrink-0">
        <div className="flex items-center gap-3 text-iris-text-primary">
          ...
          <div>
            <h2 className="text-sm font-bold tracking-[0.2em] text-iris-text-primary">VISUAL VAULT</h2>
            <p className="text-[10px] text-iris-text-secondary font-mono mt-0.5">GENERATED BY IRIS</p>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto scrollbar-small pr-2 min-h-0">
        {allImages.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center text-iris-text-secondary gap-4">
            <div className="w-20 h-20 rounded-full bg-iris-bg-secondary flex items-center justify-center border border-iris-border-primary">
            ...
            {visibleImages.map((img, index) => {
              ...
              return (
                <div
                  ...
                  className="group relative aspect-16/10 bg-iris-bg-secondary rounded-xl border border-iris-border-primary overflow-hidden hover:border-green-500/50 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] transition-all duration-300 cursor-pointer"
                >
                  <img
                    src={img.url}
                    alt={img.displayName}
